...
class ShortAutomationUI(AbstractComponentUI):
    ...
    def create_short(self, numShorts, short_type, tts_engine, language_eleven, language_edge, numImages, watermark, background_video_list, background_music_list, facts_subject, voice_eleven, fallbackImage, progress=gr.Progress()):
        '''Creates a short'''
        ...
        try:
            ...
            # Topic-based default images
            topic_defaults = {
                "Reddit Story shorts": "public/images/reddit.png",
                "Historical Facts shorts": "public/images/history.jpg",
                "Scientific Facts shorts": "public/images/science_facts.jpg",
                "Custom Facts shorts": "public/images/custom.jpg",
            }
